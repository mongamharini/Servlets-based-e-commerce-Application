                ...
                <div class="row">
                    <div class="col-md-4 text-center col-sm-6 col-xs-6">
                        <div class="thumbnail product-box">
                            <img src="m.jpg" width="100" height="100" alt="" />
                            <div class="caption">
                                <h3><a href="">MENS </a></h3>
                                  <a href="mens.jsp" class="btn btn-success" role="button">SHOP</a>
                    ...
                    <div class="col-md-4 text-center col-sm-6 col-xs-6">
                        <div class="thumbnail product-box">
                            <img src="womens.jpg" width="100" height="200" alt="" />
                            <div class="caption">
                                <h3><a href="#">WOMENS </a></h3>
                              <a href="womens.jsp" class="btn btn-success" role="button">SHOP</a>
                    ...
                    <div class="col-md-4 text-center col-sm-6 col-xs-6">
                        <div class="thumbnail product-box">
                            <img src="kids.jpg" width="100" height="100" alt="" />
                            <div class="caption">
                                <h3><a href="#">KIDS </a></h3>
                               <a href="kids.jsp" class="btn btn-success" role="button">SHOP</a>
                    ...
                    <div class="col-md-4 text-center col-sm-6 col-xs-6">
                        <div class="thumbnail product-box">
                            <img src="s.jpg" width="100" height="100" alt="" />
                            <div class="caption">
                                <h3><a href="shoes.jsp">ACCESSORIES </a></h3>
                               <a href="acc.jsp" class="btn btn-success" role="button">SHOP</a>
                            </div>
                        </div>
                    </div>
                    <!-- /.col -->

            ...
            <div class="col-md-3 text-center">
              <form name="form1" method="post" action="">
                ...
                <table width="686" border="2" id=customers align="center">
                  <tr>
                    <td>&nbsp;</td>
                    <td><strong>ORDER SUMMARY
                      <%
			    //Connection con=Dbconnection.getConnection();
	  			//String a=(String)session.getAttribute("dt");out.println(a);
				
				
	  %>
                    </strong></td>
                  <tr>
                    <td width="171"><strong>Invoice No. </strong></td>
                    <td width="336"><%String bno=(String)session.getAttribute("bb");out.println(bno);%></td>
                  <tr>
                    <td><strong>Invoice Date</strong></td>
                    <td><%String aa=(String)session.getAttribute("dt");out.println(aa);%></td>
                  </tr>
                  <tr>
                    <td><strong>Emailid</strong></td>
                    <td><%String ee=(String)session.getAttribute("emailid");out.println(ee);%></td>
                  </tr>
                  <tr>
                    <td><strong>fullname</strong></td>
                    <td><%String fa=(String)session.getAttribute("fname");out.println(fa);%></td>
                  </tr>
                  <tr>
                    <td><strong>addr</strong></td>
                    <td><%String add=(String)session.getAttribute("addr");out.println(add);%></td>
                  </tr>
                  <tr>
                    <td><strong>ph</strong></td>
                    <td><%String ph=(String)session.getAttribute("mobile");out.println(ph);%></td>
                  </tr>
                  <tr>
                    <td><strong>Date of delivery </strong></td>
                    <td><%String a=(String)session.getAttribute("dt");out.println(a);%></td>
                  </tr>
                  <tr>
                    <td><strong>Total</strong></td>
                    <td><%String b=(String)session.getAttribute("cc");out.println(b);%></td>
                  </tr>
                  <tr>
                    <td><strong>NoofItems</strong></td>
                    <td><%String dc=(String)session.getAttribute("kk");out.println(dc);%></td>
                  </tr>
                  <tr>
                    <td colspan="2"></td>
                  </tr>

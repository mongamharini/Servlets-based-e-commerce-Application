4<%@page import="dbcon.dbconnection"%>
...
try
{
      ...
      ResultSetMetaData rmd;
	   ...
	   String s1="select pid as ProductID,pdesc as ProductDescription,rate as Rate,pic as Photo,gst as GST from product where Category='ACCESSORIES'";

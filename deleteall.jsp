...
try
{
      ...
      String s1="delete from carttemp";
      stmt.executeUpdate(s1);
      stmt.close();
      con.close();
			//out.println("<script> alert('deleted successfully'); </script>");
			//out.println("<br><br><br><h1><a href=Showmycart.jsp>Return to Product</a></h1>");
  
     out.println( "<script>alert('Cart Items Deleted');window.location='showmycart.jsp';</script>");

        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="glogin.jsp">Login</a></li>
                    <li><a href="gsignup.jsp">Signup</a></li>
            ...
            <div class="col-md-3 text-center">
                ...
                <div class=" col-md-12 col-sm-6 col-xs-6">
                    ...
                    <div style="width:500px; alignment:center">
                      <table width="590" border="0" align="center" cellspacing="2">
                        <tr>
                          <td width="54">&nbsp;</td>
                          <td width="274">&nbsp;</td>
                          <td width="248" rowspan="2"><img src="why_us1-250x250.jpg" width="250" height="250"></td>
                        </tr>
                        <tr>

...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="adispatchorder.jsp">Dispatch Orders</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                <div class="well well-lg offer-box text-center"> <Br>  <h1 align="center" >Deleted Products </h1>
...
try
{
     ...
     // rs.close();
      ...
      con.close();
			...
			out.println("<br><br><br><h1><a href=eproduct.jsp>Return to Product Edit </a></h1>");

...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                <div class="well well-lg offer-box text-center"> <Br>  <h1 align="center" >Edit Products </h1>
...
try
{
      ...
      ResultSetMetaData rmd;
	   ...
	   String s1="select Category,pic as Picture,rate as Rate,pdesc as ProductDescription,pid as ProductId from product";
	
     rs = stmt.executeQuery(s1);
      
		//out.println("<body><h1><div align=center><strong><span class=style1>Edit Product</span></strong></div></h1></body>");
      
        out.println("<table border=1 align=center width=30% bordercolor=orenge id=customers ><tr>");
        ...
        for(int i=1;i<=n+1;i++)
        {
			...
			out.println("<td><b><font size=5>Review</font></b></td>");
        }
        String s="",s5="";
        while (rs.next())
        {
        ...
        out.println("<td><b><img src="+s+" width=100 height=100></img></b></td>");
                     ...
                     out.println("<td><b><a href=eproduct1.jsp?d="+s5+"><p style='color:#000'><img src=edititemicon.jpg width=50 height=50></img></p></b><a/>");
					  out.println("<b><a href=deleteproduct.jsp?d="+s5+"><p style='color:#000'><img src=deleteicon.jpg width=50 height=50 ></img></p></b><a/></td>");
					   //out.println("<td><b><a href=dproduct.jsp?d="+s5+"><img src=deleteicon.jpg width=50 height=50></img></b><a/></td>");

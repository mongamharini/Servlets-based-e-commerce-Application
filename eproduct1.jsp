            ...
            <div class="col-md-3 text-center">
                <div class=" col-md-12 col-sm-6 col-xs-6" >
                  <form name="form1" method="post" action="">
                    <table width="551" height="456" border="0px" align="center">
                      <tr>
                        <td width="63"><div align="left" class="style1">Product ID </div></td>
                        <td width="220"><label>
					 ...
					 catch(Exception e)
    {
      ...
      out.println(e);
					 ...
					 %>" />
                        ...
                        <td width="254" rowspan="5"><img src="registrationcomplete.jpg" width="175" height="227" /></td>
                      </tr>
                      <tr>
                        <td><div align="left" class="style1">Description</div></td>
                        <td><label>
                            <div align="left">
                      ...
                      <tr>
                        <td><div align="left" class="style1">Rate</div></td>
                        <td><label>
                            <div align="left">
                      ...
                      <tr>
                        <td><div align="left" class="style1">Photo</div></td>
                        <td><div align="left">
                            <input name="t4" id="t4" required="required" type="file"/>
                        </div></td>
                      </tr>
                      <tr>
                        <td><div align="left" class="style1">Category</div></td>
                        <td><label>
                      ...
                      <tr>
                        <td><div align="left" class="style1">GST % </div></td>
                        <td><div align="left">
...
if(request.getParameter("Submit")!= null)
   ...
   String ss="Update product set pdesc="+"'"+t2+"'"+",rate="+"'"+t3+"'"+",gst="+"'"+t6+"'"+" where pid="+"'"+t1+"'";
	// out.println(ss);
	 stmt.executeUpdate(ss);
      
            con.close(); 
			out.println("<h1 style='color:red'>Successfully Updated</h1>");
